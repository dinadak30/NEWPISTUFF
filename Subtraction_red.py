...
image_path1 = '/home/YCCap/ballmap/Background2.jpg'
image_path2 = '/home/YCCap/ballmap/Imagecapture2.jpg'
...
cv2.namedWindow("Detected Circle2", cv2.WINDOW_NORMAL)
cv2.setWindowProperty("Detected Circle2", cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_FULLSCREEN)
...
cv2.setMouseCallback("Detected Circle2", mouse_callback)

# Display the final image with the detected circle and midline
cv2.imshow("Detected Circle2", final_image)
cv2.imwrite('final_image2.jpg', final_image)
